...
export default {
    ...
    'f,f,ob':['伯公','几伯公','伯祖','伯翁','大爷爷','大嗲','大爷','大公','大阿爷'],
    'f,f,ob,w':['伯婆','几伯婆','姆婆','大奶奶','伯娭毑'],
    'f,f,lb':['叔公','几叔公','叔祖','叔翁','小爷爷','晚公','幺爷','细嗲'],
    'f,f,lb,w':['叔婆','几叔婆','婶婆','小奶奶','叔娭毑','晚婆','幺奶'],
    'f,f,xs':['姑奶奶','几姑奶奶','祖姑','姑奶','恩婆','姑娭毑'],
    'f,f,xs,h':['姑爷爷','几姑爷爷','祖姑丈','恩爹','姑丈公','丈公'],
    'f,m,ob':['大舅爷','大舅爹'],
    'f,m,ob,w':['大舅婆'],
    'f,m,lb':['小舅爷','小舅爹'],
    'f,m,lb,w':['小舅婆'],
    'f,m,xb':['舅爷爷','几舅爷爷','舅祖','舅爹','太舅父'],
    'f,m,xb,w':['舅奶奶','几舅奶奶','妗婆','舅婆','妗奶','太舅母'],
    'f,m,xs':['姨奶奶','几姨奶奶','姨奶','姨娭毑'],
    'f,m,xs,h':['姨爷爷','几姨爷爷','姨公','姨爹','姨丈公','丈公'],
    'm,f,ob':['伯外公','几伯外公','外伯祖','伯外祖','大外公','大姥爷','大外爷'],
    'm,f,ob,w':['伯外婆','几伯外婆','外姆婆','大外婆','大姥姥','大姥奶'],
    'm,f,lb':['叔外公','几叔外公','外叔祖','叔外祖','小外公','小姥爷','小外爷'],
    'm,f,lb,w':['叔外婆','几叔外婆','外婶婆','小外婆','小姥姥','婶姥姥','小姥奶'],
    'm,f,xs':['姑外婆','几姑外婆','姑婆','恩婆'],
    'm,f,xs,h':['姑外公','几姑外公','姑公','恩爹','外姑丈公','外丈公'],
    'm,m,xb':['舅外公','几舅外公','舅公','舅爹'],
    'm,m,xb,w':['舅外婆','几舅外婆','舅婆','妗姥姥','妗姥娘','妗姥','外妗婆'],
    'm,m,xs':['姨外婆','几姨外婆','姨婆','姨姥娘'],
    'm,m,xs,h':['姨外公','几姨外公','姨公','外姨丈公','外丈公'],
    // 父系
    ...
    'w,xs':['姨子','妻姨'],
    'w,xs,h':['连襟','姨夫','连桥','两桥','两乔','同门','僚婿','娅婿','连袂','连夹','姨夫爷','老襟','一担挑','老挑','挑担','担儿挑','连襟儿','襟兄弟','友婿','妻尹','娅'],
    'w,xs,s':['姨甥'],
    'w,xs,d':['姨甥女'],
    // 兄弟姐妹系
