...
!function (root, factory) {
    ...
    */
    ...
    var _main = {
        ...
        'm,m,m,m':['外曾外曾外祖母','高毑母'],
        // 曾祖辈
        'f,f,f':['曾祖父','曾祖','外曾外毑父','太公','太爷','老太爷','祖爷','太翁','太爷爷','三世祖'],
        ...
        'f,ob,w':['伯母','伯妈','伯娘','伯妇','阿娘','姆姆','姆','世母','大娘','大妈','大妈妈','大姆妈'],
        ...
        'm,xb,w':['舅妈','舅母','舅媳妇','舅妇','妗','妗子','妗妗','妗妈','妗娘','妗母','阿妗'],
        'm,os':['大姨','大姨妈'],
        ...
        'h,ob':['大伯子','大伯兄'],
        'h,ob,w':['大婶子','大婶儿','大伯兄姊','伯嫂','姒妇','大伯嫂','大伯妇','大伯娘','夫兄嫂'],
        'h,lb':['小叔子','小叔弟','小叔儿'],
        'h,lb,w':['小婶子','小婶儿','小叔弟妹','叔嫂','娣妇','小叔妇','小婶','夫弟妇'],
        'h,xb':['伯叔'],
        'h,xb,w':['妯娌','娣姒'],
        'h,xb,s':['叔侄','叔侄男','叔男','从男'],
        'h,xb,d':['叔侄女','叔女','从女'],
        ...
        'w,lb':['小舅子','小舅弟','舅弟'],
        'w,lb,w':['小舅妇','小舅姆','小舅弟妇','舅弟媳','小舅妹','小舅媳妇','小妗子'],
        'w,xb':['舅子','妻舅'],
        'w,xb,w':['舅嫂','妻妗'],
        'w,xb,s':['舅侄','舅侄男','舅男'],
        'w,xb,d':['舅侄女','舅女'],
    ...
    */
    ...
    var _branch = {
        ...
        'w,{G1W},h':['岳父','丈人','丈人爹'],
        'w,{G1},s&o':['大舅子','大舅兄','舅兄'],
        'w,{G1},s&o,w':['大舅妇','大舅姆','大舅兄妇','舅兄妇','舅姐','大舅姐','大妗子'],
        'w,{G1},s&l':['小舅子','小舅弟','舅弟'],
        'w,{G1},s&l,w':['小舅妇','小舅姆','小舅弟妇','舅弟妇','舅妹','小舅妹','小妗子'],
        'w,{G1},d&o':['大姨子','大姨姐','姨姐'],
